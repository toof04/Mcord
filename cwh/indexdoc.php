...
if(isset($_POST['name'])){
    ...
    $pass = $_POST['password'];
    $sql = "INSERT INTO `patient`.`doctorsignup` (`name`, `age`, `gender`, `email`, `phone`, `username`, `password`) VALUES ('$name', '$age', '$gender', '$email', '$phone', '$username', '$pass');";
    // echo $sql;
...
<body style="overflow: hidden;">
    ...
    <div class="container">
    <center><h1>Doctor Signup</h3></center>
       <div style = " margin-left: 20%; "> <p>Enter your details and submit this form  </p>
        ...
        <form action="index.php" method="post">
           ...
           <div style="border: 2px solid gray; padding:10px;margin-left:30%;position:absolute;top:35%;"> Username: <input type="username" name="username" id="username"  placeholder="Username"><br>
            <br>Password:  <input type="password" name="password" id="password"  placeholder="Password"></div>
            <div style="margin-left:39%;position:absolute;top:75%;"> <center><button class="btn">Submit</button> </center>
           <?php
        if($insert == true){
